...
public class LayeringMachineTileEntity extends ComplexMachineTileEntity {

    public LayeringMachineTileEntity() {
        super(6000000, 5, 2000);
        this.activeEU = 600;
    ...
    public void consume() {
        ...
        int[] ingredientsConsume = ITcRecipes.layering_machine.getIngirientsConsume(input1, input2, input3);
    ...
    public void operate() {
        ItemStack output = ITcRecipes.layering_machine.getResult(this.inputSlot.get(0), this.inputSlot.get(1), this.inputSlot.get(2));

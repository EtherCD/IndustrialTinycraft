...
public class ProcessorAssemblerTileEntity  extends TileEntityElectricMachine implements IHasGui, IGuiValueProvider, IUpgradableBlock {
    protected final int idleEU = 0;
    protected final int activeEU = 100;

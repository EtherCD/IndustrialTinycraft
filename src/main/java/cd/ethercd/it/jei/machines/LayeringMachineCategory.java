...
public class LayeringMachineCategory extends IORecipeCategory<TriInputRecipeManager> implements IDrawable {
    private final IDrawableStatic bg;
    public static final String UID = IndustrialTinyCraft.MODID + ".layering_machine";

    public LayeringMachineCategory(IGuiHelper h) {
        super(ITcMachine.crystal_grower, ITcRecipes.industrial_soldering_station);
        bg = h.createDrawable(new ResourceLocation(IndustrialTinyCraft.MODID + ":textures/gui/layering_machine.png"), 33, 18, 100, 49);
    }

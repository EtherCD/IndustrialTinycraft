...
public class TriInputRecipeWrapper implements IRecipeWrapper {
    private final ItemStack firstInput;
    private final ItemStack secondInput;
    private final ItemStack tridInput;
    private final ItemStack output;

    public TriInputRecipeWrapper(ItemStack firstInput, ItemStack secondInput, ItemStack tridInput, ItemStack output) {

...
public class CrystalSlicerCategory extends IORecipeCategory<IBasicMachineRecipeManager> implements IDrawable {
    private final IDrawableStatic bg;
    public static final String UID = IndustrialTinyCraft.MODID + ".crystal_slicer";

    public CrystalSlicerCategory(IGuiHelper h) {
